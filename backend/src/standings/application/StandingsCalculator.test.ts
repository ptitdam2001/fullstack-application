...
function match(id: string, home: string, away: string, homeGoals: number | null, awayGoals: number | null, status = MatchStatus.PLAYED, forfeitedBy: string | null = null): Match {
  return { id, groupId: 'g1', status, scheduledAt: null, area, homeTeamId: home, awayTeamId: away, homeGoals, awayGoals, forfeitedBy }
}
