...
export type GetMeQuery = { __typename?: 'Query', getMe?: { __typename?: 'getMeOutput', status?: string | null, user?: { __typename?: 'User', id?: string | null, email?: string | null, name?: string | null, role?: string | null, photo?: string | null, updatedAt?: number | null, createdAt?: number | null } | null } | null };

export type LogoutUserQueryVariables = Exact<{ [key: string]: never; }>;


export type LogoutUserQuery = { __typename?: 'Query', logoutUser?: { __typename?: 'LogoutUser', status?: string | null } | null };

export type RefreshAccessTokenQueryVariables = Exact<{ [key: string]: never; }>;


export type RefreshAccessTokenQuery = { __typename?: 'Query', refreshAccessToken?: { __typename?: 'RefreshAccessToken', status?: string | null, access_token?: string | null } | null };
...
export type LoginUserMutation = { __typename?: 'Mutation', loginUser?: { __typename?: 'LoginOutput', status?: string | null, access_token?: string | null } | null };
...
export const useLogoutUserQuery = <
    ...
    >(
      ...
      options?: Omit<UseQueryOptions<LogoutUserQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<LogoutUserQuery, TError, TData>['queryKey'] },
      headers?: RequestInit['headers']
    ) => {
...
export const useRefreshAccessTokenQuery = <
    ...
    >(
      ...
      options?: Omit<UseQueryOptions<RefreshAccessTokenQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<RefreshAccessTokenQuery, TError, TData>['queryKey'] },
      headers?: RequestInit['headers']
    ) => {
    ...
    queryFn: fetcher<RefreshAccessTokenQuery, RefreshAccessTokenQueryVariables>(client, RefreshAccessTokenDocument, variables, headers),
    ...options
  }
    )};
...
export const useLoginUserMutation = <
    ...
    mutationFn: (variables?: LoginUserMutationVariables) => fetcher<LoginUserMutation, LoginUserMutationVariables>(client, LoginUserDocument, variables, headers)(),
    ...options
  }
    )};
