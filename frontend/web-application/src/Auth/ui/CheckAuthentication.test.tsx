...
describe('CheckAuthentication', () => {
  it('renders children when user authenticated', () => {
    vi.mocked(AuthProvider.useAuthValue).mockReturnValue({ user: { id: '1', email: 'a@b.com', firstname: 'A', lastname: 'B', role: 'PLAYER' }, token: 'tok' })

    renderWithProviders(<CheckAuthentication><div>protected</div></CheckAuthentication>)
