...
── Gestion ──────────────────────
  Championnats                   → /app/admin/championships
  Équipes                        → /app/admin/teams
  Matchs sans score (N)          → /app/games [badge dynamique]
  Utilisateurs                   → /app/admin/users
  Activations en attente (N)     → /app/admin/users [badge dynamique]
