...
2. **Frontend SDK**: `orval` generates typed axios+react-query hooks into `frontend/web-application/src/sdk/generated/`
3. **Zod schemas**: also generated by orval into `frontend/web-application/src/sdk/generated/*.zod.ts`
